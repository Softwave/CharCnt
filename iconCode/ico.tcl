...
#
# 09/12/2020 - DRL - Corrected ::ico::getIconMembersICO to support 256x256 icons.
...
proc ::ico::getIconMembersICO {file name} {
    ...
    for {set i 0} {$i < $num} {incr i} {
	    ...
	    # D.R. LaBelle - The following line has been replaced in order to handle 256 x 256 icons.
